...
@Controller
@RequestMapping("/ch03") // contextroot/ch03 (contextroot가 생략돼어 있음)
public class Ch03Controller {
	...
	public String content() {
		...
		public String method1(
			String param1,
			String param2, 파라미터가 없으면 null로 들어옴
			String param3,
			String param4,
			String param5
		) {
		...
		/*		@GetMapping("/method1")
				public String method1(
					String param1,
					@RequestParam(defaultValue ="0") int param2, // 파라미터가 없다면 error가 뜸 , null은 int가 아니기 때문 디폴트 값 넣기
	...
	public String method1(Ch03Dto dto) {
		...
		logger.info("param4: " + dto.isParam4()); // boolean타입의 getter는 is임
